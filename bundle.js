...
/***/ function(module, exports, __webpack_require__) {
	...
	var drumEvents = __webpack_require__(10);
...
/***/ function(module, exports) {
	...
	var app = {
	  ...
	  api: 'https://drum-sequencer.herokuapp.com'
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = __webpack_require__(6);
	var drumPatterns = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var knobJQuery = __webpack_require__(9);
	// const drumUi = require('./drumUi');


	var triggerGrid = ['pad 1', 'pad 2', 'pad 3', 'pad 4', 'pad 5', 'pad 6', 'pad 7', 'pad 8', 'pad 9', 'pad 10', 'pad 11', 'pad 12', 'pad 13', 'pad 14', 'pad 15', 'pad 16'];
	...
	var clearBeat = function clearBeat() {
	  for (var key in beat) {
	    var _drum = beat[key];
	    for (var i = 0; i < triggerGrid.length; i++) {
	      _drum[i] = false;
	    }
	  }
	  console.log(beat);
	...
	var mapPatternsToIndicators = function mapPatternsToIndicators(inst) {
	  for (var i = 0; i < triggerGrid.length; i++) {
	    var selected = void 0;
	    if (beat[inst][i] === true) {
	      selected = triggerGrid[i];
	      $(".pad[data-grid ='" + selected + "']").closest('.pad').find('.trigger.indicator').addClass('clicked');
	    } else {
	      selected = triggerGrid[i];
	      $(".pad[data-grid ='" + selected + "']").closest('.pad').find('.trigger.indicator').removeClass('clicked');
	    }
	  }
	};
	...
	var constructPattern = function constructPattern(drum, index) {
	  // console.log(drum);
	  for (var i = 0; i < triggerGrid.length; i++) {
	...
	var userSelectDrum = function userSelectDrum(inst) {
	  drum = inst;
	};

	var padIndex = function padIndex(grid) {
	  constructPattern(drum, grid);
	};

	var replacePatternFromData = function replacePatternFromData(object) {
	...
	module.exports = {
	  ...
	  padIndex: padIndex,
	  userSelectDrum: userSelectDrum,
	  beat: beat,
	  mapPatternsToIndicators: mapPatternsToIndicators,
	  replacePatternFromData: replacePatternFromData,
	  clearBeat: clearBeat
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getFormFields = __webpack_require__(4);
	var drumApi = __webpack_require__(11);
	var drumPatterns = __webpack_require__(8);
	...
	var onShowBeat = function onShowBeat(id) {
	  ...
	  // console.log(data);
	  event.preventDefault();
	  drumApi.beatShow(id).done(drumUi.showBeatSuccess).fail(drumUi.showBeatFailure);
	};

	var onShowAllBeats = function onShowAllBeats(event) {
	  event.preventDefault();
	  var data = drumUi.patternId;
	  drumApi.beatShowAll(data).done(drumUi.showAllSuccess).fail(drumUi.failure);
	};

	var onCreateBeat = function onCreateBeat(event) {
	  var data = getFormFields(this);
	  // console.log(data);
	  // dataId = data.beats.id;
	  event.preventDefault();
	  drumApi.beatCreate(data).done(drumUi.createSuccess).fail(drumUi.failure);
	};

	var onUpdateBeat = function onUpdateBeat() {
	  console.log(drumUi.id);
	  // console.log(drumPatterns.beat);
	  if (typeof drumUi.id === 'undefined') {
	    drumUi.updateBeatFailure();
	  } else {
	    var stringKick = JSON.stringify(drumPatterns.beat.kick);
	    var stringSnare = JSON.stringify(drumPatterns.beat.snare);
	    var stringHatClose = JSON.stringify(drumPatterns.beat.hatClose);
	    var stringHatOpen = JSON.stringify(drumPatterns.beat.hatOpen);
	    var stringClap = JSON.stringify(drumPatterns.beat.clap);
	    // console.log(stringKick,stringSnare,stringHatClose,stringHatOpen,stringClap);
	...
	var onDeleteBeat = function onDeleteBeat(event) {
	  event.preventDefault();
	  // console.log(id);
	  drumApi.beatDelete(drumUi.id).done(drumUi.deleteBeatSuccess(drumUi.id)).fail(drumUi.failure);
	};

	//event handlers below
	var currentDrum = void 0;

	var addDrumHandlers = function addDrumHandlers() {
	  ...
	  $('.drum.button').click(function () {
	    $(this).closest('.drum-select').find('.drum.indicator').toggleClass('clicked');
	    $(this).attr('disabled', true);

	    //turn on the correct indicator for each drum type
	    $('.drum.button').not(this).closest('.drum-select').find('.drum.indicator').removeClass('clicked');
	  ...
	  $('.pad').click(function () {
	    var currentGrid = $(this).data('grid');
	...
	module.exports = {
	  addDrumHandlers: addDrumHandlers
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	//GET SHOW
	var beatShow = function beatShow(id) {
	  return $.ajax({
	...
	//GET INDEX
	var beatShowAll = function beatShowAll(data) {
	  return $.ajax({
	    url: app.api + '/beats/',
	    method: 'GET',
	    data: data,
	...
	//POST CREATE
	var beatCreate = function beatCreate(data) {
	  return $.ajax({
	    url: app.api + '/beats/',
	    method: 'POST',
	    headers: {
	...
	//PATCH
	var beatUpdate = function beatUpdate(id, dataKick, dataSnare, dataHatClose, dataHatOpen, dataClap) {
	...
	//DESTROY
	var beatDelete = function beatDelete(dataId) {
	  return $.ajax({
	...
	module.exports = {
	  beatCreate: beatCreate,
	  beatShowAll: beatShowAll,
	  beatShow: beatShow,
	  beatUpdate: beatUpdate,
	  beatDelete: beatDelete
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var deleteBeatSuccess = function deleteBeatSuccess(event) {
	  drumPatterns.clearBeat();
	...
	var displayBeats = function displayBeats(data) {
	  var beatTemplate = __webpack_require__(13);
	...
	var showBeatSuccess = function showBeatSuccess(data) {
	...
	var updateBeatSuccess = function updateBeatSuccess() {
	  // console.log(data)
	...
	var showBeatFailure = function showBeatFailure(error) {
	  drumPatterns.clearBeat();
	...
	var updateBeatFailure = function updateBeatFailure(error) {
	...
	module.exports = {
	  ...
	  showBeatSuccess: showBeatSuccess,
	  showBeatFailure: showBeatFailure,
	  deleteBeatSuccess: deleteBeatSuccess,
	  updateBeatSuccess: updateBeatSuccess,
	  updateBeatFailure: updateBeatFailure,
	  failure: failure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n\n"
	    ...
	    + "\n<!-- <h2 class=\"message\">Open File</h2> -->\n    <!-- <h1> <small> "
	    + container.escapeExpression(container.lambda((depth0 != null ? depth0.name : depth0), depth0))
	    + "</small></h1> -->\n    <!-- <div> -->\n      <!-- "
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.desc : depth0),{"name":"if","hash":{},"fn":container.program(2, data, 0),"inverse":container.program(4, data, 0),"data":data})) != null ? stack1 : "")
	    + " -->\n    <!-- </div> -->\n\n";
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.beats : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<!-- <ul class='list'> -->\n<li class = \"list\" data-id=\""
	    ...
	    + "\"><a href =\"#\"><h2 class=\"message\">"
	    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
	    + "</h2></a></li>\n<!-- </ul> -->\n<!-- <br>The id of the folloving beat "
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + " -->\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "1e670d88b23c7ab956f1829e3828a210.ttf";
