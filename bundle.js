...
/***/ function(module, exports, __webpack_require__) {
	...
	var drumEvents = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var signInSuccess = function signInSuccess(data) {
	  ...
	  $('.command-bottom').empty().append('<h2>Ready to make some beats?</h2>').fadeIn(2000).delay(2000).fadeOut(1000);
	...
	var signOutSuccess = function signOutSuccess() {
	  delete app.user;
	  console.log(app);
	  $('.command-top').empty().append('<h2>User: ' + user + '<br>Sign out successful</h2>').fadeOut(2000);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getFormFields = __webpack_require__(4);
	var drumApi = __webpack_require__(9);
	...
	var getIdNum = function getIdNum(idNum) {
	  dataId = idNum;
	};

	var onShowBeat = function onShowBeat(event) {
	  var data = getFormFields(this);
	  dataId = data.beats.id;
	  console.log(data);
	  event.preventDefault();
	  drumApi.beatShow(data).done(drumUi.showBeatSuccess).fail(drumUi.showBeatFailure);
	};
	...
	var onDeleteBeat = function onDeleteBeat(event) {
	  event.preventDefault();
	  drumApi.beatDelete(dataId).done(drumUi.deleteBeatSuccess(event)).fail(drumUi.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	//GET SHOW
	var beatShow = function beatShow(data) {
	  return $.ajax({
	...
	//PATCH
	var beatUpdate = function beatUpdate(dataNum, dataKick, dataSnare, dataHatClose, dataHatOpen, dataClap) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var drumApi = __webpack_require__(9);
	var drumEvents = __webpack_require__(8);
	var knobJQuery = __webpack_require__(11);
	...
	var num = void 0;
	var userSelectId = function userSelectId(idNum) {
	  num = idNum;
	};

	var onSaveBeat = function onSaveBeat() {
	  var stringKick = JSON.stringify(beat.kick);
	  var stringSnare = JSON.stringify(beat.snare);
	  var stringHatClose = JSON.stringify(beat.hatClose);
	  var stringHatOpen = JSON.stringify(beat.hatOpen);
	  var stringClap = JSON.stringify(beat.clap);
